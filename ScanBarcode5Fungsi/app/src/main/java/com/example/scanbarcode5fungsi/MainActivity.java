package com.example.scanbarcode5fungsi;
    ...
    protected void onActivityResult (int requestCode,int resultCode,Intent data ){
        ...
        if (result != null) {
            ...
            if (result.getContents() == null) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"madezikri13@gmail.com"});
                intent.putExtra(Intent.EXTRA_CC, new String[]{"madezikri14@gmail.com"});
                intent.putExtra(Intent.EXTRA_SUBJECT, "Fungsi Email");
                intent.putExtra(Intent.EXTRA_TEXT, "Muhammad Ade Zikri-TI.21.C.3-312110364");
                try {
